...
class CustomData:
    def __init__(self,gender:str,race_ethnicity:str,parental_level_of_education:str,
                 lunch:str,test_preparatory_course:str,reading_score:str,writing_score:str):
        self.gender = gender
        self.race_ethnicity = race_ethnicity
        self.parental_level_of_education = parental_level_of_education
        self.lunch = lunch
        self.test_preparatory_course = test_preparatory_course
    ...
    def get_data_as_data_frame(self):
        custom_data_input_dict = {
            ...
            "lunch" : [self.lunch],
            "test_preparatory_course" : [self.test_preparatory_course],
